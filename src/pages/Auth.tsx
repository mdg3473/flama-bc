...
const Auth = () => {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-4 bg-background">
      <div className="w-full max-w-md bg-card border-2 border-border rounded-lg p-8 relative">
        <div className="absolute -top-2 -left-2 right-2 bottom-2 border-2 border-primary rounded-lg -z-0" />
