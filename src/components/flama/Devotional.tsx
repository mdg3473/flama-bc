        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div ref={pop.ref} className={`${pop.className} relative flex flex-col justify-end`}>
            <div className="ml-auto max-w-xl text-right">
              ...
              <div className="mono text-xs text-white bg-primary rounded-lg inline-block px-3 py-1 mb-3">SALMOS 27:1</div>
              ...
              <div className="flex flex-wrap gap-2 justify-end">
                <a href="#" className="mono text-[10px] px-4 py-2 rounded-lg bg-neutral-900 text-white font-bold tracking-widest hover:bg-primary transition-colors">
                  ← ONTEM
                </a>
                <a href="#" className="mono text-[10px] px-4 py-2 rounded-lg bg-primary text-primary-foreground font-bold tracking-widest hover:bg-primary-glow transition-colors">
                  ARQUIVO COMPLETO
                </a>
              </div>
            </div>
