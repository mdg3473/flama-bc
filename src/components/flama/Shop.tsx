    ...
    >
            <div className="relative aspect-square overflow-hidden border-2 border-border bg-card group-hover:border-primary transition-colors">
              ...
              <button
                ...
                className="absolute bottom-4 right-4 h-12 w-12 bg-foreground text-background flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors disabled:opacity-60"
              >
